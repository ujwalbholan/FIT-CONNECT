  ...
  <body>
    <div class="container">
      <div class="sidebar">
        ...
        <nav>
        <ul>
            <li><a href="../../includes/profile/trainerProfile.php" class="active">Profile</a></li>
            <li>
              <a href="http://localhost/FIT-CONNECT/view/page/trainerDashboard/trainerDashbord.php"
                >Dashboard</a
              >
            </li>
            <li><a href="http://localhost/FIT-CONNECT/view/includes/task/taskTrainers.php">Tasks</a></li>
      ...
      <div class="main-content">
        ...
        <div class="profile-section">
          ...
          <form id="profileForm" action="http://localhost/FIT-CONNECT/controller/trainesProfileData.php" 
            method="POST"
            enctype="multipart/form-data"
            >

            <input type="hidden" id="trainer_id" value="1">
            ...
            <input type="number"  id="training_price" name="training_price">
