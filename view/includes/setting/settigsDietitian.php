  ...
  <body>
    <div class="container">
      <div class="sidebar">
        ...
        <nav>
        <ul>
            <li><a href="../../includes/profile/dieticianProfile.php">Profile</a></li>
            <li>
              <a
            ...
            <li><a href="http://localhost/FIT-CONNECT/view/includes/setting/settigsDietitian.php"  class="active">Settings</a></li>
          </ul>
        </nav>
      </div>
